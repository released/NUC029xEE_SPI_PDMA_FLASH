...
#define SPI_FLASH_CS_LOW						((void) NULL)//(PC8 = 0)
#define SPI_FLASH_CS_HIGH						((void) NULL)//(PC8 = 1)
#else
#define SPI_FLASH_CS_LOW						(PC8 = 0)
#define SPI_FLASH_CS_HIGH						(PC8 = 1)
#endif
...
#define SPI_FLASH_CLK_FREQ  					(800000)
#define SPI_FLASH_PORT  						(SPI1)
#define SPI_FLASH_TX_DMA_CH 					(2)
#define SPI_FLASH_RX_DMA_CH 					(3)
